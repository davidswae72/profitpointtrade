<template>
  ...
  >
    <v-alert
      ...
      class="py-3 primary rounded-lg d-flex align-center"
    >
      <div class="d-flex align-center ml-n2 ml-sm-0 light--text">

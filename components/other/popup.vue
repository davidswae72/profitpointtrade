<template>
  <v-snackbar
    ...
    elevation="24"
  >
    <div class="light--text text-subtitle-1 font-weight-medium">
      {{ name }}
    </div>
    <div>
      made

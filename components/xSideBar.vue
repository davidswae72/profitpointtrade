<template>
  ...
  >
    ...
    <v-card height="100%" dark flat class="dark py-4">
      <v-card-title
        class="text-h6 font-weight-medium text3--text d-flex align-start"
      >
        <slot name="header" />
        <v-spacer />
        <v-icon color="secondary" right @click="toggle(false)">
          mdi-close
        </v-icon>
      </v-card-title>
